-- Als er reeds een database met de naam "academic" bestaat op je MySQL-server,
-- dan zal dit script normaal gezien falen. Dat is voor de veiligheid,
-- zodat je niet per ongeluk een bestaande databank wist.

-- Weet je zeker dat je de bestaande "academic"-database wilt wissen
...
CREATE TABLE AD_STUDENT_ATTENDANCE
  (
     STUDENT_ID         DECIMAL ,
     SESSION_ID		DECIMAL ,
     NUM_WORK_DAYS   	DECIMAL NOT NULL,
     NUM_DAYS_OFF      	DECIMAL NOT NULL,
...
ALTER TABLE AD_FACULTY_LOGIN_DETAILS MODIFY LOGIN_DATE_TIME TIMESTAMP DEFAULT now();
...
INSERT INTO AD_STUDENTS VALUES(720, 'JACK','SMITH', STR_TO_DATE('01-Jan-2012','%e-%b-%Y'),'JSMITH@SCHOOL.EDU', 600);
INSERT INTO AD_STUDENTS VALUES(730, 'NOAH', 'AUDRY', STR_TO_DATE('01-Jan-2012','%e-%b-%Y'),'NAUDRY@SCHOOL.EDU', 640);
INSERT INTO AD_STUDENTS VALUES(740, 'RHONDA','TAYLOR', STR_TO_DATE('01-Sep-2012','%e-%b-%Y'),'RTAYLOR@SCHOOL.EDU', 620);
INSERT INTO AD_STUDENTS VALUES(750, 'ROBERT','BEN', STR_TO_DATE('01-Mar-2012','%e-%b-%Y'),'RBEN@SCHOOL.EDU', 610);
INSERT INTO AD_STUDENTS VALUES(760, 'JEANNE','BEN', STR_TO_DATE('01-Mar-2012','%e-%b-%Y'),'JBEN@SCHOOL.EDU', 610);
INSERT INTO AD_STUDENTS VALUES(770, 'MILLS','CARMEN', STR_TO_DATE('01-Apr-2013','%e-%b-%Y'),'MCARMEN@SCHOOL.EDU', 630);
...
INSERT INTO AD_EXAMS VALUES(500, STR_TO_DATE('12-Sep-2013','%e-%b-%Y'),'MCE',190);
INSERT INTO AD_EXAMS VALUES(510, STR_TO_DATE('15-Sep-2013','%e-%b-%Y'),'SA', 191);
INSERT INTO AD_EXAMS VALUES(520, STR_TO_DATE('18-Sep-2013','%e-%b-%Y'),'FIB', 192);
INSERT INTO AD_EXAMS VALUES(530, STR_TO_DATE('21-Mar-2014','%e-%b-%Y'),'ESS', 193);
INSERT INTO AD_EXAMS VALUES(540, STR_TO_DATE('02-Apr-2014','%e-%b-%Y'),'TF', 194);
...
ALTER TABLE AD_FACULTY_LOGIN_DETAILS ADD  DETAILS  VARCHAR(50);
